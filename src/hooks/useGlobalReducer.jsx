...
import { fetchAgenda, createContact, getContacts, updateContact, deleteContact } from "./actions";
...
export default function useGlobalReducer() {
    const { dispatch, store, fetchAgenda, createContact, getContacts, updateContact, deleteContact } = useContext(StoreContext)
    return { dispatch, store, fetchAgenda, createContact, getContacts, updateContact, deleteContact };
}